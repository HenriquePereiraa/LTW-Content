...
package ltw.content.service.service.base;
...
/**
 * Provides the base implementation for the ltw_content local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link ltw.content.service.service.impl.LTW_contentLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see ltw.content.service.service.impl.LTW_contentLocalServiceImpl
 * @generated
 */
public abstract class LTW_contentLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, LTW_contentLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LTW_contentLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>LTW_contentLocalServiceUtil</code>.
	 */
	...
	public LTW_content createLTW_content(long ltwId) {
		return ltw_contentPersistence.create(ltwId);
	}
	...
	public LTW_content deleteLTW_content(LTW_content ltw_content) {
		return ltw_contentPersistence.remove(ltw_content);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return ltw_contentPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			LTW_content.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ltw_contentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return ltw_contentPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ltw_contentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return ltw_contentPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public LTW_content fetchLTW_content(long ltwId) {
		return ltw_contentPersistence.fetchByPrimaryKey(ltwId);
	}
	...
	public LTW_content fetchLTW_contentByUuidAndGroupId(
		...
		return ltw_contentPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public LTW_content getLTW_content(long ltwId) throws PortalException {
		return ltw_contentPersistence.findByPrimaryKey(ltwId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ltw_contentLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(LTW_content.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("ltwId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			ltw_contentLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(LTW_content.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("ltwId");
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<LTW_content>() {

				@Override
				public void performAction(LTW_content ltw_content)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, ltw_content);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return ltw_contentPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement LTW_contentLocalServiceImpl#deleteLTW_content(LTW_content) to avoid orphaned data");
		}

		return ltw_contentLocalService.deleteLTW_content(
			(LTW_content)persistedModel);
	}

	@Override
	public BasePersistence<LTW_content> getBasePersistence() {
		return ltw_contentPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return ltw_contentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<LTW_content> getLTW_contentsByUuidAndCompanyId(
		...
		return ltw_contentPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<LTW_content> getLTW_contentsByUuidAndCompanyId(
		...
		return ltw_contentPersistence.findByUuid_C(
	...
	public LTW_content getLTW_contentByUuidAndGroupId(String uuid, long groupId)
		...
		return ltw_contentPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<LTW_content> getLTW_contents(int start, int end) {
		return ltw_contentPersistence.findAll(start, end);
	}
	...
	public int getLTW_contentsCount() {
		return ltw_contentPersistence.countAll();
	}
	...
	protected void deactivate() {
		LTW_contentLocalServiceUtil.setService(null);
	}

	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LTW_contentLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		ltw_contentLocalService = (LTW_contentLocalService)aopProxy;

		LTW_contentLocalServiceUtil.setService(ltw_contentLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return LTW_contentLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ltw_contentPersistence.getDataSource();
	...
	protected LTW_contentLocalService ltw_contentLocalService;

	@Reference
	protected LTW_contentPersistence ltw_contentPersistence;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LTW_contentLocalServiceBaseImpl.class);
