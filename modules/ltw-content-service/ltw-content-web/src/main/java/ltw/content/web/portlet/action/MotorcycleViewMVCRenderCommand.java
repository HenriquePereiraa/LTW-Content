...
@Component (
        property = {
                ...
                "mvc.command.name=/ltwContent/motorcycle-view"
        },
        service = MVCRenderCommand.class
)
public class MotorcycleViewMVCRenderCommand implements MVCRenderCommand {
    @Override
    public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
        return "/ltwContent/motorcycle-view.jsp";
    }
}
