...
public abstract class BaseLTW_contentResourceImpl
	implements EntityModelResource, LTW_contentResource,
			   VulcanBatchEngineTaskItemDelegate<LTW_content> {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/ltw-content-rest/v1.0/ltw-content/{ltwContentId}'  -u 'test@liferay.com:test'
	 */
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/ltw-content-rest/v1.0/ltw-content/{ltwContentId}/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/ltw-content/{ltwContentId}/batch")
	...
	public Response deleteLTW_contentBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.deleteImportTask(
				LTW_content.class.getName(), callbackURL, object)
		).build();
	}
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'PUT' 'http://localhost:8080/o/ltw-content-rest/v1.0/ltw-content/{ltwContentId}'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.PUT
	@Override
	public LTW_content putLTW_Content(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.validation.constraints.NotNull
			@javax.ws.rs.PathParam("ltwContentId")
			Long ltwContentId,
	...
	public void create(
			Collection<LTW_content> ltw_contents,
	...
	public void setContextBatchUnsafeBiConsumer(
		UnsafeBiConsumer
			<Collection<LTW_content>,
			 UnsafeFunction<LTW_content, LTW_content, Exception>, Exception>
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<LTW_content>, UnsafeConsumer<LTW_content, Exception>,
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseLTW_contentResourceImpl.class);
